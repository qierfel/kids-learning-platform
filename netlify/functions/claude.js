exports.handler = async (event) => {
  ...
  if (type === 'poem_explain') {
    // payload: { title, author, dynasty, lines }
...
请用一句话（不超过30字）提示学生为什么选这个答案，不要直接说出答案。`
    ...
    // payload: { subject, topic, question, myAnswer, correctAnswer }
...
语气温和鼓励，不超过120字。`
    ...
    // payload: { subject, topic, question, correctAnswer, grade }
...
[
  ...
  {"q": "题目3", "a": "答案3"}
    ...
    // payload: { question, history: [{role, content}], subject }
