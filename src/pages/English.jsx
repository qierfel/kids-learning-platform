...
const TOOLS = [
  ...
  { id: 'grammar',  icon: '📐', label: '语法讲解', desc: '10章63个知识点 · AI练习题', ready: true },
...
export default function English({ user }) {
  ...
  function handleAddMistake(mistake) {
    // Could integrate with Mistakes page via localStorage or parent state
    // For now store in localStorage for Mistakes page to pick up
    try {
  ...
  return (
    <div className="subject-page">
      <h2 className="subject-title">英语 <span className="edition">听说读写 · 词汇 · 语法</span></h2>
